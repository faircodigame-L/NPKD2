...
Cleverhans toolbox for implementing CW, PGD and FGSM attacks
...
Model_path = "fmnist_dist_det_DCNN.pth"


# evaluate the model
loss, acc = model.evaluate(x_test, y_test, verbose=1)
print('CNN clean Model Accuracy on F_MNIST : %.4f' % (acc*100))
# make a prediction
image = x_train[1]
...
print('NN Model Accuracy on F_MNIST after Attack: %.3f' % (pois_acc*100))
...
plt.title('F_MNIST CNN Confusion matrix')
plt.colorbar()
...
print("Clean F_MNIST samples peak-to-peak Value: ", x_train.ptp())
...
print("RBF deviations obtained between clean and FGSM F_MNIST \n ", Rbf_d_fgm)
print("RBF mean Deviation fgsm poisoning on F_MNIST : ", Rbf_d_fgm.mean())


plt.title ='RBF measure between clean and fgsm F_MNIST images'
...
plt.title = "RBF Deviation: Clean vs FGSM-Poisoned F_MNIST"
...
plt.title = "Laplace Deviation: Clean vs FGSM-Poisoned F_MNIST"
...
plt.title = "RBF Deviation: Clean vs PGD-Poisoned F_MNIST"
plt.xlabel("RBF Deviation (1 - similarity)")
plt.ylabel("Frequency")
plt.legend()
plt.show()
...
plt.title = "Laplace Deviation: Clean vs PGD-Poisoned F_MNIST"
plt.xlabel("Laplace Deviation (1 - similarity)")
plt.ylabel("Frequency")
plt.legend()
plt.show()
...
print('CNN Model Accuracy on F_MNIST after Attack: %.3f' % (pois_acc*100))
print('No.of Poisoning points : ', n_pois)
...
plt.title = "RBF Deviation: Clean vs CW-Poisoned F_MNIST"
plt.xlabel("RBF Deviation (1 - similarity)")
plt.ylabel("Frequency")
plt.legend()
plt.show()
...
plt.title = "Laplace Deviation: Clean vs CW-Poisoned F_MNIST"
plt.xlabel("Laplace Deviation (1 - similarity)")
plt.ylabel("Frequency")
plt.legend()
plt.show()
